...
<?php
    if(isset($_POST['submit']))
    {
        ...
        $res = DynDb_Update('tb_renter', array(
            'renter_fullname', $renter_fullname,
            'renter_birth', $renter_birth,
            'renter_address', $renter_address,
            //'renter_id_card', $renter_id_card,
        ...
        if($res > 0)
        {
            ...
            echo $cls_conn->goto_page(0,'update_renter.php');
        //    echo $sql;
        }
        else
        {
