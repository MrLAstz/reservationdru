                                 ...
                                 ?>
                                    <tr>
                                       <td >
                                        ...
                                        <a href="#">
                                            <?php echo $row['active'] ? "กำลังเช่า" : "สิ้นสุดแล้ว" ?>
                                                 </a>
                                        </td>
                                       
                                        
                                        <td id="pp" style="text-align: center">
                                            <a href="show_payment.php?renter_id=<?=$row['renter_id'];?>"
                                                class="btn btn-info btn-xs nav-link"><i class="ti-info-alt"></i> แสดง
                                            </a>
                                       <!--
                                            <a href="delete_renter.php?id=<?=$row['bk_id'];?>"
                                                class="btn btn-warning btn-xs nav-link" onclick="return confirm('คุณต้องการลบหรือไม่?')"><i class="ti-info-alt"></i> รายละเอียด
                                            </a>
                                        -->
                                            <?php if ($row['active']) : ?>
