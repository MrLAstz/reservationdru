...
public $db_password; // "drmg";
public $db_database; // "reservationdru";
    
public function __construct() {
    global $Configs;
    $this->db_server = $Configs["SERVER"];
    $this->db_username = $Configs["USERNAME"];
    $this->db_password = $Configs["PASSWORD"];
    $this->db_database = $Configs["DATABASE"];
}
